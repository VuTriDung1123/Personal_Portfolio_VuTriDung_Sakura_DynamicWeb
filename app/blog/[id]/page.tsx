...
export default function BlogPost({
  ...
  useEffect(() => {
    ...
    Promise.all([getPostById(id), getSectionContent("global_config")]).then(
      ([postData, configData]) => {
      ...
      <main style={{ fontFamily: "'Noto Sans', sans-serif" }}>
        ...
        {isLoading ? (
              ...
              >
                <ReactMarkdown
                  ...
                  components={{
                    ...
                    p: ({ node, ...props }) => (
                      <p {...props} style={{ marginBottom: "1.2em" }} />
                    ),
                    h1: ({ node, ...props }) => (
                      <h1
                        {...props}
          ...
          <div style={{ textAlign: "center", paddingTop: "150px" }}>
            <h1 style={{ color: "#8d6e63", fontSize: "2rem" }}>
              Post not found 🍃
            </h1>
            <Link
              href="/blog"
