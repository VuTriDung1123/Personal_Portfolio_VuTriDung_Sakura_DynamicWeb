...
export const translations = {
  en: {
    ...
    hero_iam: "I am a",
    hero_desc:
      "Passionate about building world-class web applications and secure systems.",
    ...
    about_line1:
      "I am a third-year IT student at UTH University with a strong passion for coding and problem-solving. And I love mathematics too.",
    about_line2:
      "I love turning complex ideas into reality through elegant code.",
    ...
    career_desc:
      "To become a Full-stack Developer and a Cyber Security Expert in the next 5 years.",

    sec_achievements: "05. ACHIEVEMENTS", // Thay cho sec_hobby
    achievements_desc:
      "Competitions and academic events I have participated in.",
    ...
    exp_desc_1:
      "Building responsive websites and web applications for clients.",
  ...
  vi: {
    ...
    hero_iam: "Tôi là một",
    hero_desc:
      "Đam mê xây dựng các ứng dụng web đẳng cấp và hệ thống bảo mật an toàn.",
    ...
    about_line1:
      "Tôi là sinh viên năm 3 ngành CNTT tại UTH với niềm đam mê mãnh liệt với lập trình. Và tôi cũng rất thích toán học.",
    about_line2:
      "Tôi thích biến những ý tưởng phức tạp thành hiện thực thông qua những dòng code tinh tế.",
    ...
    career_desc:
      "Trở thành Full-stack Developer và Chuyên gia An ninh mạng trong 5 năm tới.",

    sec_achievements: "05. THÀNH TỰU",
    achievements_desc:
      "Các cuộc thi và sự kiện học thuật tôi đã tham gia (Không quan trọng giải thưởng).",
  ...
  jp: {
    ...
    hero_iam: "私は",
    hero_desc:
      "世界クラスのWebアプリケーションと安全なシステムの構築に情熱を注いでいます。",
    ...
    sec_about: "01. 私について",
    about_line1:
      "私はUTH大学の3年生で、コーディングと問題解決に強い情熱を持っています。数学も好きです。",
    about_line2:
      "複雑なアイデアをエレガントなコードで実現することが大好きです。",
    ...
    career_desc:
      "今後5年でフルスタック開発者およびサイバーセキュリティの専門家になること。",
